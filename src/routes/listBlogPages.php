...
$app->post('/api/Blogger/listBlogPages', function ($request, $response) {
    ...
    $optionalParams = ['fetchBodies'=>'fetchBodies','view'=>'view','status'=>'status'];
    $bodyParams = [
       'query' => ['fetchBodies','view','status']
    ];
