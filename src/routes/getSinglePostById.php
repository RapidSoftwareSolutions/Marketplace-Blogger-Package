...
$app->post('/api/Blogger/getSinglePostById', function ($request, $response) {
    ...
    $optionalParams = ['maxComments'=>'maxComments','view'=>'view','fetchBody'=>'fetchBody','fetchImages'=>'fetchImages'];
    $bodyParams = [
       'query' => ['maxComments','view','fetchBody','fetchImages']
    ];
